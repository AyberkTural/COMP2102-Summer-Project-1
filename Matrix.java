public class Matrix  {
 ...
 private static class MatrixNode <E> { 
...
static class Navigator {
    ...
    Matrix.MatrixNode whereAreYou() { 
    
        int spawnx = (int)(Math.random()*(matrix.D));
  
        int spawny = (int)(Math.random()*(matrix.D));
        
        Matrix.MatrixNode temp = matrix.initial;    
        
        Matrix.MatrixNode location = null;
     ...
     Matrix.MatrixNode N (Matrix.MatrixNode voyager) {
       
      Matrix.MatrixNode temp = voyager; 
     ...
     Matrix.MatrixNode S (Matrix.MatrixNode voyager) {
     ...
     Matrix.MatrixNode E (Matrix.MatrixNode voyager) {
    ...
    Matrix.MatrixNode W (Matrix.MatrixNode voyager) {
